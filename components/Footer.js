...
const Footer = () => {
    return (
        <div className='flex flex-col items-center py-10 bg-gray-900 text-gray-100'>
            <div className='max-w-6xl mx-auto'>
                <h1 className='text-xl font-bold'>rajkopodinic</h1>
            </div>
            <div className='max-w-6xl mx-auto justify-between'>
                <h1 className=''>© Rajko Podinic {date.getFullYear()}</h1>
